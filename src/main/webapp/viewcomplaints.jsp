...
<body style="background-color: #013329;">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                ...
                <button class="btn btn-primary" type="button" style="background-color:#013329;color: white;">
                    <a href="adminmenu.jsp" class="link-offset-2 link-underline link-underline-opacity-0 link-light">
		...
		<thead>
  		...
  		<tbody>
  			M<c:forEach items="${clist}" var="c">
    		<tr>
      			<th scope="row">${c.userid}</th>
      			<td><c:out value="${c.dept}" /></td>
      			<td><c:out value="${c.parent}" /></td>
      			<td><c:out value="${c.section}" /></td>
