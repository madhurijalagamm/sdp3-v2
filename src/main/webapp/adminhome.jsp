...
<body style="background-color: #ebe5dc;">
    <div>
        ...
        <div class="col-md-1">
        <br><br>
        <button class="btn btn-primary" type="submit" style="background-color:#013329; color:black"><a href="adminlogin" class="link-offset-2 link-underline link-underline-opacity-0 link-light">Logout</a></button>
        </div>
        </div>
        <br><br>
        <div class="row">
        ...
        <p id="anotherStatCount" style="color:red">${ucount}</p>
    	</div>
    	</div>
    	</div>
        </div>
